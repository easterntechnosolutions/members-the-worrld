...
class DB_Connect {
  public  $con1;
    ...
    public function connect() {
		...
		//$con = mysqli_connect("localhost","root","","pharma") or die("Connection Failed...!");
		
		$con = mysqli_connect(Xcrud_config::$dbhost,Xcrud_config::$dbuser,Xcrud_config::$dbpass,Xcrud_config::$dbname) or die("Connection Failed...!");
        // selecting database
		if (!$con)
  {
  die("Connection error: " . mysqli_connect_errno());
    ...
    public function insert($query) {
		...
		if(!$res)
		{
			return ("Error : " . mysqli_error($this->con1));
		}
		else{
