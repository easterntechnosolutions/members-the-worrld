...
class Xcrud_config
{
   ...
   /* public static $dbname = 'theabzz2_theabsolutestore'; // Your database name
    public static $dbuser = 'theabzz2_tas'; // Your database username
    public static $dbpass = 'Think_TAS_12'; // // Your database password
    public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.
*/
  public static $dbname = 'theworld_book'; // Your database name
    public static $dbuser = 'theworld_book'; // Your database username
    public static $dbpass = 'theworld_book'; // // Your database password
    public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.
   ...
   // public static $editor_url = 'editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    public static $editor_url = 'http://cdn.ckeditor.com/4.5.11/full/ckeditor.js';
    ...
    // map
    public static $default_point = '51.253775,-85.32321400000001';
    public static $default_text = 'Rx Pharm';
